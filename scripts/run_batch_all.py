#!/usr/bin/env python3
"""
Batch script to run depth densification on all datasets in the data directory.
"""
...
def run_densification_for_dataset(dataset_name: str, batch_config: BatchConfig) -> bool:
    """Run depth densification for a single dataset."""
...
def main(config: BatchConfig):
    ...
    logger.info("Starting batch depth densification process")
